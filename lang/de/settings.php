...
$lang['closedwiki']            = 'Dies ist ein geschlossenes Wiki. Die meisten Wiki-Funktionen werden ausgeblendet, bevor sich der Benutzer angemeldet hat.';
$lang['copyright']             = 'Copyright-Hinweis. Verwenden Sie %year%, %title% und %TITLE% als Platzhalter. Kann HTML enthalten. Eventuell möchten Sie den Standard-Lizenzhinweis deaktivieren.';
